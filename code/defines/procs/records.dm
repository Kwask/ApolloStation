/proc/CreateGeneralRecord()
	...
	G.fields["photo_front"]	= dummy.character.account.preview_icon_front
	G.fields["photo_side"]	= dummy.character.account.preview_icon_side
