...
/obj/machinery/mecha_part_fabricator/Topic(href, href_list)
	...
	if(href_list["part_set"])
		var/tpart_set = input_filter.getStr("part_set")
		if(tpart_set)
			if(tpart_set=="clear")
				src.part_set = null
			else
				...
				screen = "parts"
	if(href_list["part"])
		var/obj/part = input_filter.getObj("part")
	...
	if(href_list["add_to_queue"])
		var/obj/part = input_filter.getObj("add_to_queue")
	...
	if(href_list["remove_from_queue"])
		remove_from_queue(input_filter.getNum("remove_from_queue"))
		return update_queue_on_page()
	if(href_list["partset_to_queue"])
		add_part_set_to_queue(input_filter.get("partset_to_queue"))
		return update_queue_on_page()
...
*/
	...
	if(href_list["queue_move"] && href_list["index"])
		var/index = input_filter.getNum("index")
		var/new_index = index + input_filter.getNum("queue_move")
	...
	if(href_list["part_desc"])
		var/obj/part = input_filter.getObj("part_desc")
